...
/**
 * GUARDRAIL: Theme Presets from tweakcn
 *
 * This file contains ALL theme presets from the tweakcn project.
 * When customizing themes:
 * 1. Use the CSS variable structure defined here
 * 2. Maintain light/dark mode parity
 * 3. Export custom themes using this format
 * 4. Visit https://tweakcn.com to create and export new themes
 *
 * DO NOT modify the CSS variable names - they are part of the shadcn/ui contract.
 */
...
export const defaultPresetKey = "default";
